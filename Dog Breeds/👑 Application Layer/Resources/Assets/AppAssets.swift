...
enum AppAssets {
    ...
    static var iconListBullets: UIImage? {
        let img = UIImage(named: "iconListBullets")
        return img
    }
    
    static var iconStar: UIImage? {
        let img = UIImage(named: "iconStar")
        return img
    }
    
    static var iconStarPlus: UIImage? {
        let img = UIImage(named: "iconStarPlus")
        return img
    }
